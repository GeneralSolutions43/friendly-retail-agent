"""Models for the retail agent backend."""
...
class Product(SQLModel, table=True):
    """Product model for the retail store."""
...
def receive_before_insert_or_update(_mapper, _connection, target):
    """Automatically update embedding before inserting or updating a product."""
